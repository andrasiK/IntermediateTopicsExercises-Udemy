    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            DbCommand commandToExecute = new DbCommand("Select * from File1",newConnection);
            commandToExecute.Execute();

            Console.ReadLine();

            OracleConnection newConnection2 = new OracleConnection("oracleConnectionString");
            DbCommand commandToExecute2 = new DbCommand("Delete * from File2",newConnection2);
            commandToExecute2.Execute();
